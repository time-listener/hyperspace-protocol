...
import org.xmlrobot.genesis.Recurrence;
...
/**
 * A {@link PastMass} that is {@link Recurrence}.
 * @author joan
 *
 */
public interface RecurrenceMass<K,V> 
	extends PastMass<K>, PastCallable<Positron<K,V>> {
     ...
     * (<a href="{@docRoot}/java/util/Collection.html#optional-restrictions">optional</a>)
     */
    boolean hasPositive(MassListener sender, Mass<K> event);
     ...
     * (<a href="{@docRoot}/java/util/Collection.html#optional-restrictions">optional</a>)
     */
    boolean hasNegative(MassListener sender, Mass<V> event);
	 ...
	 */
	Graviton<V,K> callByNegative(MassListener sender, Mass<V> event);
	 ...
	 * @return null if positron hasn't been found
	 */
	Graviton<K,V> callByPositive(MassListener sender, Mass<K> event);
     ...
     * (<a href="{@docRoot}/java/util/Collection.html#optional-restrictions">optional</a>)
     */
    Mass<V> callNegative(MassListener sender, Mass<K> event);
     ...
     * @since 1.8
     */
    Mass<V> callNegativeOrDefault(MassListener sender, Mass<K> event, Mass<V> defaultAntievent);
     ...
     * (<a href="{@docRoot}/java/util/Collection.html#optional-restrictions">optional</a>)
     */
    Mass<K> callPositive(MassListener sender, Mass<V> event);
     ...
     * @since 1.8
     */
    Mass<K> callPositiveOrDefault(MassListener sender, Mass<V> event, Mass<K> defaultAntievent);
     ...
     * @since 1.8
     */
    void unifyNegative(MassListener sender, Mass<K> event, Mass<V> antievent, 
     ...
     * @since 2
     */
    void unifyPositive(MassListener sender, Mass<V> event, Mass<K> antievent,
     ...
     * @since 1.8
     */
    void relocateAllNegatives(MassListener sender, Commandment<K,V> event);
     ...
     * @since 1.8
     */
    void relocateAllPositives(MassListener sender, Commandment<V,K> unificationFunction);
     ...
     * @since 1.8
     */
    void relocateNegative(MassListener sender, Mass<K> event, Mass<V> antievent);
     ...
     * @since 1.8
     */
    void relocateNegative(MassListener sender, Mass<K> event, Mass<V> oldAntievent, Mass<V> newAntievent);
     ...
     * @since 2
     */
    void relocatePositive(MassListener sender, Mass<V> event, Mass<K> antievent);
     ...
     * @since 1.8
     */
    void relocatePositive(MassListener sender, Mass<V> event, Mass<K> oldAntievent, Mass<K> newAntievent);
     ...
     * @since 2
     */
    void forEveryNegative(MassListener sender, Imperative<V,K> event);
     ...
     * @since 1.8
     */
    void forEveryPositive(MassListener sender, Imperative<K,V> event);
     ...
     * @since 1.8
     */
    void processNegative(MassListener sender, Mass<K> event, 
     ...
     * @since 1.8
     */
    void processNegativeIfAbsent(MassListener sender, Mass<K> event,
     ...
     * @since 2
     */
    void processPositive(MassListener sender, Mass<V> event, 
     ...
     * @since 2
     */
    void processPositiveIfAbsent(MassListener sender, Mass<V> event, 
     ...
     * @since 2
     */
    void redeemNegative(MassListener sender, Mass<V> event);
     ...
     * @since 1.8
     */
    void redeemPositive(MassListener sender, Mass<K> event);
     ...
     * @since 2
     */
    void redeemNegative(MassListener sender, Mass<V> event, Mass<K> antievent);
     ...
     * @since 1.8
     */
    void redeemPositive(MassListener sender, Mass<K> event, Mass<V> antievent);
     ...
     *         or antievent prevents it from being stored in this mass
     */
    void setNegative(MassListener sender, Graviton<K,V> event);
     ...
     *         or antievent prevents it from being stored in this mass
     */
    void setNegative(MassListener sender, Mass<K> event, Mass<V> antievent);
     ...
     * @since 1.8
     */
    void setNegativeIfAbsent(MassListener sender, Mass<K> event, Mass<V> antievent);
     ...
     */
    void setPositive(MassListener sender, Graviton<V,K> antievent);
     ...
     *         or event prevents it from being stored in this mass
     */
    void setPositive(MassListener sender, Mass<V> event, Mass<K> antievent);
     ...
     * @since 2
     */
    void setPositiveIfAbsent(MassListener sender, Mass<V> event, Mass<K> antievent) ;
}