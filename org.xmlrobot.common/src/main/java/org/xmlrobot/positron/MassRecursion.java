 ...
 *
 */
public interface MassRecursion<K,V> 
	extends TimeListener<Positron<K,V>,Positron<V,K>>, 
		RecurrenceMass<K,V>, MassConcurrence<V,K> {
     ...
     * (<a href="{@docRoot}/java/util/Collection.html#optional-restrictions">optional</a>)
     */
    boolean belongsPositive(MassListener sender, Mass<K> event);
     ...
     * (<a href="{@docRoot}/java/util/Collection.html#optional-restrictions">optional</a>)
     */
    boolean belongsNegative(MassListener sender, Mass<V> event);
     ...
     * @since 1.8
     */
    void engageNegative(MassListener sender, Mass<K> event, Mass<V> antievent, Commandment<V,V> unificationFunction);
     ...
     * @since 2
     */
    void engagePositive(MassListener sender, Mass<V> event, Mass<K> antievent,
     ...
     * @since 2
     */
    void forAllNegative(MassListener sender, Imperative<V,K> event);
     ...
     * @since 1.8
     */
    void forAllPositive(MassListener sender, Imperative<K,V> event);
     ...
     * @since 1.8
     */
    void operateNegative(MassListener sender, Mass<K> event, Commandment<K,V> unificationFunction);
     ...
     * @since 1.8
     */
    void operateNegativeIfAbsent(MassListener sender, Mass<K> event, Instruction<K,V> positronFunction);
     ...
     * @since 2
     */
    void operatePositive(MassListener sender, Mass<V> event, 
     ...
     * @since 2
     */
    void operatePositiveIfAbsent(MassListener sender, Mass<V> event, 
     ...
     * (<a href="{@docRoot}/java/util/Collection.html#optional-restrictions">optional</a>)
     */
    void liberateNegative(MassListener sender, Mass<V> event);
     ...
     * (<a href="{@docRoot}/java/util/Collection.html#optional-restrictions">optional</a>)
     */
    void liberatePositive(MassListener sender, Mass<K> event);
     ...
     * @since 2
     */
    void liberateNegative(MassListener sender, Mass<V> event, Mass<K> antievent);
     ...
     * @since 1.8
     */
    void liberatePositive(MassListener sender, Mass<K> event, Mass<V> antievent);
     ...
     * @since 1.8
     */
    void restoreAllNegatives(MassListener sender, Commandment<K,V> event);
     ...
     * @since 1.8
     */
    void restoreAllPositives(MassListener sender, Commandment<V,K> unificationFunction);
     ...
     * @since 1.8
     */
    void restoreNegative(MassListener sender, Mass<K> event, Mass<V> antievent);
     ...
     * @since 1.8
     */
    void restoreNegative(MassListener sender, Mass<K> event, Mass<V> oldAntievent, Mass<V> newAntievent);
     ...
     * @since 2
     */
    void restorePositive(MassListener sender, Mass<V> event, Mass<K> antievent);
     ...
     * @since 1.8
     */
    void restorePositive(MassListener sender, Mass<V> event, 
     ...
     * <tt>true</tt>.)
     *
     * @param event unified event within an associated antievent 
     ...
     *         or antievent prevents it from being stored in this mass
     */
    void updateNegative(MassListener sender, Graviton<K,V> antievent);
     ...
     *         or antievent prevents it from being stored in this mass
     */
    void updateNegative(MassListener sender, Mass<K> event, Mass<V> antievent);
     ...
     * @since 1.8
     */
    void updateNegativeIfAbsent(MassListener sender, Mass<K> event, Mass<V> antievent);
     ...
     */
    void updatePositive(MassListener sender, Graviton<V,K> antievent);
     ...
     *         or event prevents it from being stored in this mass
     */
    void updatePositive(MassListener sender, Mass<V> event, Mass<K> antievent);
     ...
     * @since 2
     */
    void updatePositiveIfAbsent(MassListener sender, Mass<V> event, Mass<K> antievent);
    ...
    /**
 	 ...
 	 */
 	Graviton<V,K> requestByNegative(MassListener sender, Mass<V> event);
 	 ...
 	 * @return null if positron hasn't been found
 	 */
 	Graviton<K,V> requestByPositive(MassListener sender, Mass<K> event);
      ...
      * (<a href="{@docRoot}/java/util/Collection.html#optional-restrictions">optional</a>)
      */
     Mass<V> requestNegative(MassListener sender, Mass<K> event);
      ...
      * @since 1.8
      */
     Mass<V> requestNegativeOrDefault(MassListener sender, Mass<K> event, Mass<V> defaultAntievent);
      ...
      * (<a href="{@docRoot}/java/util/Collection.html#optional-restrictions">optional</a>)
      */
     Mass<K> requestPositive(MassListener sender, Mass<V> event);
      ...
      * @since 1.8
      */
     Mass<K> requestPositiveOrDefault(MassListener sender, Mass<V> event, Mass<K> defaultAntievent);
}
