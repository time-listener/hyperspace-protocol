 ...
 *
 */
public interface MetaConcurrence<V,K>
	extends MetaFuture<V>, RunnableFuture<Metatext<V,K>> {
     ...
     */
	Mass<V> acquireTo(MassListener sender, AtomicInteger N);
     ...
     *         (<tt>index &lt; 0 || index &gt;= size()</tt>)
     */
	Mass<K> acquireFrom(MassListener sender, AtomicInteger N);
     ...
     *         (<tt>index &lt; 0 || index &gt;= size()</tt>)
     */
	Mass<K> acquireFrom(MassListener sender, Mass<V> event);
     ...
     *         (<tt>index &lt; 0 || index &gt;= size()</tt>)
     */
	Mass<V> acquireTo(MassListener sender, Mass<K> event);
     ...
     * (<a href="{@docRoot}/java/util/Collection.html#optional-restrictions">optional</a>)
     */
    boolean holdsTo(MassListener sender, Mass<V> event);
     ...
     * (<a href="{@docRoot}/java/util/Collection.html#optional-restrictions">optional</a>)
     */
    boolean holdsFrom(MassListener sender, Mass<K> event);
     ...
     *         (<a href="Collection.html#optional-restrictions">optional</a>)
     */
    AtomicInteger pointerOfTo(MassListener sender, Mass<V> event);
     ...
     *         (<a href="Collection.html#optional-restrictions">optional</a>)
     */
    AtomicInteger pointerOfFrom(MassListener sender, Mass<K> event);
     ...
     *         (<tt>index &lt; 0 || index &gt;= size()</tt>)
     */
	Meta<K,V> assignFrom(MassListener sender, AtomicInteger N, Meta<K,V> event);
     ...
     *         (<tt>index &lt; 0 || index &gt;= size()</tt>)
     */
	Meta<V,K> assignTo(MassListener sender, AtomicInteger N, Meta<V,K> event);
     ...
     *         prevents it from being added to this hypothetical mass
     */
	void assignTo(MassListener sender, Meta<V,K> event);
     ...
     *         prevents it from being added to this hypothetical mass
     */
	void assignFrom(MassListener sender, Meta<K,V> event);
     ...
     *         prevents it from being added to this hypothetical mass
     */
	void assignFrom(MassListener sender, Mass<V> event, Mass<K> antievent);
     ...
     *         prevents it from being added to this hypothetical mass
     */
	void assignTo(MassListener sender, Mass<K> event, Mass<V> antievent);
     ...
     * (<a href="{@docRoot}/java/util/Collection.html#optional-restrictions">optional</a>)
     */
	void releaseTo(MassListener sender, AtomicInteger N, Mass<V> event);
     ...
     * (<a href="{@docRoot}/java/util/Collection.html#optional-restrictions">optional</a>)
     */
    void releaseFrom(MassListener  sender, AtomicInteger N, Mass<K> event);
     ...
     *         (<tt>index &lt; 0 || index &gt;= size()</tt>)
     */
    void releaseFrom(MassListener sender, AtomicInteger N);
     ...
     *         (<tt>index &lt; 0 || index &gt;= size()</tt>)
     */
	void releaseTo(MassListener sender, AtomicInteger N);
     ...
     */
	Congregation<V> subsequenceTo(MassListener sender, AtomicInteger beginIndex, AtomicInteger endIndex, Congregation<V> event);
     ...
     *             greater than {@code end}.
     */
	Congregation<K> subsequenceFrom(MassListener sender, AtomicInteger beginIndex, AtomicInteger endIndex, Congregation<K> event);
}